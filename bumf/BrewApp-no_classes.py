...
dict_from_file("preferences.txt", favourite_drinks)
...
def assign_person():
    try:
        ...
        favourite_drinks[people[chosen_person]] = drinks[chosen_drink]
...
def get_favourites():
    tabulate_dict("favourites", favourite_drinks)
...
def get_command():
    ...
    if command == GET_PEOPLE_CMD:
        ...
        save_dict_to_file("preferences.txt", favourite_drinks)
